...
define(['./workbox-1e60b829'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https?:\/\/.*\/api\/reports(?!.*\/map)/, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https?:\/\/.*\/api\/reports\/map/, new workbox.StaleWhileRevalidate({
